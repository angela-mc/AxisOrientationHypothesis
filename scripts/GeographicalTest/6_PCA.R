...
read.csv(file="data/Re_analysisGEbarriers/P2_datamodel/dfB0.csv", stringsAsFactors = F)->dfB0
colnames(dfB0)
    ...
    # write.csv(dfB0, file="data/Re_analysisGEbarriers/P2_datamodel/dfB0_perSO_av.csv")

read.csv(file="data/Re_analysisGEbarriers/P2_datamodel/dfB0_perSO_av.csv", stringsAsFactors = F)->dfB0 # average using median per society of origin
...
pcaik$rotation
library(nFactors)
ev <- eigen(cor(dataPCA)) # get eigenEstimates

  # (1) all Ds+ MCOSTe, (2)  xeric , (3) temp, (4) allSimSocE
...
#save(myPCA, file="data/Re_analysisGEbarriers/P2_datamodel/dfi0_PCA_nf4/myPCA.rds")
#save(myPCA, file="data/Re_analysisGEbarriers/P2_datamodel/dfi0_PCA_nf4/myPCA_perSO_av.rds")
...
#write.csv(dfB0, file="data/Re_analysisGEbarriers/P2_datamodel/dfi0_PCA_nf4/dfB_PCA.csv")
#write.csv(dfB0, file="data/Re_analysisGEbarriers/P2_datamodel/dfi0_PCA_nf4/dfB_PCA_perSO_av.csv")
...
read.csv(file="data/Re_analysisGEbarriers/P2_datamodel/dfB2500.csv", stringsAsFactors = F)->dfB2500
colnames(dfB2500)
    ...
    # write.csv(dfB2500, file="data/Re_analysisGEbarriers/P2_datamodel/dfB2500_perSO_av.csv")

read.csv(file="data/Re_analysisGEbarriers/P2_datamodel/dfB2500_perSO_av.csv", stringsAsFactors = F)->dfB2500
namesC<-c("West Africa T", "Sudanic_Savan","W_African_Sav", "Ethipian plat","E_North_Ameri","Mesoamerica","Southwes amaz" ,"C/S_Andes","NW_Lowland_SA", "N_Lowland_SA" ,"Fertile_Cresc" , "W_Yuman_E_Tib", "Chinese_loess", "South trop ch" , "Ganges_E_Indi" , "Lower-MiddleY"  , "Sava_W_India" ,"S_India")
conts1<-c("Africa", "Africa","Africa", "Africa","NorthAmerica","Mesoamerica","SouthAmerica" ,"SouthAmerica","SouthAmerica", "SouthAmerica" ,"Asia" , "Asia", "Asia", "Asia" , "Asia" , "Asia"  , "Asia" ,"Asia")
dfB2500$cont<- -999
...
myPCA$loadings
  ...
  # (1) geoD + elevation cost, (2) all xeric(Turnover&Diss), (4) temp diss&turnover, (3) LCPl xeric&temp

#save(myPCA, file="data/Re_analysisGEbarriers/P2_datamodel/dfi2500_PCA_nf5/myPCA.rds")
#save(myPCA, file="data/Re_analysisGEbarriers/P2_datamodel/dfi2500_PCA_nf5/myPCA_perSO_av.rds")
...
#write.csv(dfB2500, file="data/Re_analysisGEbarriers/P2_datamodel/dfi2500_PCA_nf5/dfB_PCA.csv")
#write.csv(dfB2500, file="data/Re_analysisGEbarriers/P2_datamodel/dfi2500_PCA_nf5/dfB_PCA_perSO_av.csv")
