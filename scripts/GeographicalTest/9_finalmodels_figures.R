...
load(file="data/Re_analysisGEbarriers/P2_datamodel/dfi0_PCA_nf4/models_space/mod1_area.rds") ; mod1->mod1cr
load(file="data/Re_analysisGEbarriers/P2_datamodel/dfi0_PCA_nf4/models_space/mod2_area.rds") ; mod2->mod2cr
load(file="data/Re_analysisGEbarriers/P2_datamodel/dfi0_PCA_nf4/models_space/mod3_area.rds") ; mod3->mod3cr
load(file="data/Re_analysisGEbarriers/P2_datamodel/dfi0_PCA_nf4/models_space/mod4_area.rds") ; mod4->mod4cr

read.csv(file="data/Re_analysisGEbarriers/P2_datamodel/dfi0_PCA_nf4/dfB_PCA_perSO_av.csv", stringsAsFactors = F)-> dfb0
RC_namescr<-c("GeoD_LCPsl_MCOSTe", "NrSocSimE", "TempD_MCOSTt","XericD_MCOSTx") 
RCscr<-c("RC1", "RC2","RC3","RC4") # NrSocSimE has negative loading
...
# cr
pdf("manuscript/1FinalSub_JuneNature/Fig3/Fig3a_altorder.pdf", height = 8,width = 13)
par(mfrow=c(2,2))
par(mar=c(c(2, 7, 2, 2)))
...
mtext("a", font=2, side=3,adj=0)
par(mar=c(c(2, 7, 2, 2)))
find_order_barriers_venom(names_lvls,lvls, dfb0, whichRC="RC2", title="Scarcity of nodes in the\necological neighborhood", add_to_lim1=0,add_to_lim2=0.3, add_to_axis=0.5,cexp = "equal")
par(mar=c(c(2, 7, 2, 2)))
...
par(mar=c(c(2, 7, 2, 2)))
find_order_barriers_venom(names_lvls,lvls, dfb0, whichRC="RC4", title="Aridity turnover", add_to_lim1=5, add_to_lim2=2,add_to_axis=2,cexp = "equal")
dev.off()
...
pdf(paste0("manuscript/1FinalSub_JuneNature/Fig3/cr_Tukey_areas1_",fulldata,"_matrix.pdf"), height = 5, width = 5)
par(mar=c(2,2,2,2))
...
pdf(paste0("manuscript/1FinalSub_JuneNature/Fig3/cr_Tukey_areas2_",fulldata,"_matrix.pdf"), height = 5, width = 5)
par(mar=c(2,2,2,2))
...
pdf(paste0("manuscript/1FinalSub_JuneNature/Fig3/cr_Tukey_areas3_",fulldata,"_matrix.pdf"), height = 5, width = 5)
par(mar=c(2,2,2,2))
...
pdf(paste0("manuscript/1FinalSub_JuneNature/Fig3/cr_Tukey_areas4_",fulldata,"_matrix.pdf"), height = 5, width = 5)
par(mar=c(2,2,2,2))
