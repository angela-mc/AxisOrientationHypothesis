...
for(i in 1:length(soci1))
  ...
  if(!is.na(valueO))
    ...
    save(result, file=paste0("/Users/Angela/Desktop/other/BOX_15march/GeogrAxes/data/Re_analysisGEbarriers/paleoclim2021/P2_temp0_",whichk,"/temp_", socO,".rds"))
...
for(i in 1:length(soci1))
  ...
  if(!is.na(valueO))
    ...
    save(result, file=paste0("/Users/Angela/Desktop/other/BOX_15march/GeogrAxes/data/Re_analysisGEbarriers/paleoclim2021/P2_temp2500_",whichk,"/temp_", socO,".rds"))
