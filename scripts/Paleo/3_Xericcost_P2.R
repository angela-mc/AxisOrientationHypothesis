...
TempHarshness_rasterscaled<-XericHarshness_raster
values(TempHarshness_rasterscaled)<-scale(values(XericHarshness_raster))

# here I named everything as TempHarshness_rasterscaled to match temp code
...
for(i in 1:length(soci1))
  ...
  if(!is.na(valueO))
    ...
    save(result, file=paste0("/Users/Angela/Desktop/other/BOX_15march/GeogrAxes/data/Re_analysisGEbarriers/paleoclim2021/P2_xeric0_",whichk,"/temp_", socO,".rds"))
...
save(result, file=paste0("/Users/Angela/Desktop/other/BOX_15march/GeogrAxes/data/Re_analysisGEbarriers/paleoclim2021/P2_xeric2500_",whichk,"/temp_", socO,".rds"))
