...
pdf(paste0("data/Re_analysisGEbarriers/paleoclim2021/P2_datamodel_", whichk,"/dfi0_PCA_nf4/MI_nospace","_oragr.pdf"), height = 15, width = 10)
par(mfrow=c(4,2))
...
pdf(paste0("data/Re_analysisGEbarriers/paleoclim2021/P2_datamodel_", whichk,"/dfi2500_PCA_nf4/MI_nospace","_oragr.pdf"), height = 15, width = 10)
par(mfrow=c(4,2)) # 4 models
...
if(whichk%in%c("8k","12k" , "4k")) plot(0, xaxt = 'n', yaxt = 'n', bty = 'n', pch = '', ylab = '', xlab = '') 
  # DOES NOT NEED SAC
