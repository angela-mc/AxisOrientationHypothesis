...
whichk<-"8k" ; threshold5q<-0.065437155
whichk<-"12k" ; threshold5q<-0.068214172
whichk<-"4k" ; threshold5q<-0.066218187
    ...
    if(length(coordinates(raster_costO)[which(values(raster_costO)%in%0),])==2) # if ok
      {print(paste("rtoP",print(Sys.time())))
        ...
        if(length(mat[polO,][mat[polO,]%in%1])>1) 
        {
          ...
          save(unifiedPolygons2, file=paste0("/Users/Angela/Desktop/other/BOX_15march/GeogrAxes/data/Re_analysisGEbarriers/paleoclim2021/peopleinspaceTemp5QT_", whichk,"/", soci1[i], ".rds"))
          } # from mtargetgr
        } # from nonb
...
save(nonb, file=paste0("/Users/Angela/Desktop/other/BOX_15march/GeogrAxes/data/Re_analysisGEbarriers/paleoclim2021/peopleinspaceTemp5QT_", whichk,"/nonb.rds"))
save(multiple0, file=paste0("/Users/Angela/Desktop/other/BOX_15march/GeogrAxes/data/Re_analysisGEbarriers/paleoclim2021/peopleinspaceTemp5QT_", whichk,"/multiple0.rds"))
save(mtargetgr, file=paste0("/Users/Angela/Desktop/other/BOX_15march/GeogrAxes/data/Re_analysisGEbarriers/paleoclim2021/peopleinspaceTemp5QT_", whichk,"/mtargetgr.rds"))
