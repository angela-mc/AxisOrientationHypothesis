...
for(i in 1: length(traits_of_interest))
  ...
  # datafor model
  load(file=paste0("data/Re_analysisGEbarriers/P1_datamodel/dfmFamID/","socnames_pertrait_",trait_of_interest,".rda")) # socnames
  load(file=paste0("data/Re_analysisGEbarriers/P1_datamodel/dfmFamID/","ctraits_pertrait_",trait_of_interest,".rda")) # ctraits_values
  load(file=paste0("data/Re_analysisGEbarriers/P1_datamodel/dfmFamID/","sharefam_values_pertrait_",trait_of_interest,".rda")) #sharefam_values
  
  load(file=paste0("data/Re_analysisGEbarriers/P1_datamodel/dfmFamID/","edTemp_values_",trait_of_interest,".rda")) # 
  load(file=paste0("data/Re_analysisGEbarriers/P1_datamodel/dfmFamID/","edXeric_values_",trait_of_interest,".rda")) # 
  load(file=paste0("data/Re_analysisGEbarriers/P1_datamodel/dfmFamID/","gdist_valuesGeo_pertrait_",trait_of_interest,".rda")) # gdist_values
  ...
  dfm<-as.data.frame(cbind(pairsoc_US[tokeepF], pairsoc_S[tokeepF], socnames[tokeepF,1],socnames[tokeepF,2],ctraits_values[tokeepF],
                           sharefam_values[tokeepF],edTemp_values[tokeepF],edXeric_values[tokeepF],gdist_values[tokeepF]))
  colnames(dfm)<-c("pairsoc_US","pairsoc_S","soc1", "soc2","share","famid","edTemp","edXeric", "geod") 
  ...
  write.csv(dfm, file=paste0("data/Re_analysisGEbarriers/P1_datamodel/dfmFamIdS1/dfmS1_", trait_of_interest, ".csv"))
  print(i)
}
