...
for(i in 1: length(traits_of_interest))
  ...
  load(file=paste0("data/Re_analysisGEbarriers/P1_datamodel/dfmEDGE/","pd_values_pertrait_",trait_of_interest,".rda")) # pd_values  
  ...
  write.csv(dfm, file=paste0("data/Re_analysisGEbarriers/P1_datamodel/dfmEDGES1/dfmS1_", trait_of_interest, ".csv"))
  print(i)
}
